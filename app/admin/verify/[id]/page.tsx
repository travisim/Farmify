...
export default function VerificationPage({
  ...
  const amountsMatch =
    verificationData.reportedRevenue ===
    verificationData.extractedData.totalAmount;

  return (
    <div className="min-h-screen bg-background">
      <Header title="AgriVest Admin">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Review and verify settlement documentation
          </p>
        </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Sales documentation provided by farmer
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Automatically parsed information from the document
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm">
                      {verificationData.extractedData.buyerName}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm font-medium">Sale Date:</span>
                    <span className="text-sm">
                      {verificationData.extractedData.saleDate}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm font-medium">Document Type:</span>
                    <span className="text-sm">
                      {verificationData.extractedData.documentType}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm font-medium">Currency:</span>
                    <span className="text-sm">
                      {verificationData.extractedData.currency}
                    </span>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Cryptographic verification and storage details
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Project and farmer information
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-mono text-xs mt-1">
                        {verificationData.farmerAddress.slice(0, 12)}...
                        {verificationData.farmerAddress.slice(-12)}
                      </p>
                    </div>
                    <div>
                      <Label className="font-medium">Investor Count:</Label>
                      <p className="mt-1">
                        {verificationData.investorCount} investors
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="mt-1">
                        ${verificationData.projectValue.toLocaleString()} RLUSD
                      </p>
                    </div>
                    <div>
                      <Label className="font-medium">Reported Revenue:</Label>
                      <p className="mt-1 font-bold">
                        ${verificationData.reportedRevenue.toLocaleString()}{" "}
                        RLUSD
                      </p>
                    </div>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Compare reported vs extracted amounts
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Original project information and performance
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {verificationData.projectDetails.expectedYield} tons
                    </span>
                  </div>
                  <div className="flex justify-between">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Calculated distribution amounts
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
              ...
              >
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will approve the settlement, create an immutable
                      record on XRPL, and trigger automatic profit distribution
              ...
              >
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will reject the settlement submission and notify the
                      farmer. Please ensure you have documented the reasons for
                      rejection in the verification notes.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
